...
<div class="box">
    <div class="box-header">
        <div class="left">
            <h3 class="box-title">Recommended Posts</h3>
            <br>
            <small class="pull-left">You can see recommended posts here</small>
        </div>
        <div class="right">
                                ...
                                <td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu pull-right options-list">
                                            <li>
                                                <a href="<?php echo base_url(); ?>admin/update-post/<?php echo html_escape($item->id); ?>?redirect_url=recommended-posts">
