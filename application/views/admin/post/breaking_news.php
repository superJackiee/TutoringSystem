...
<div class="box">
    <div class="box-header">
        <div class="left">
            ...
            <br>
            <small class="pull-left">You can see breaking news here</small>
        </div>
        <div class="right">
                                ...
                                <td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu pull-right options-list">
                                            <li>
                                                <a href="<?php echo base_url(); ?>admin/update-post/<?php echo html_escape($item->id); ?>?redirect_url=breaking-news">
