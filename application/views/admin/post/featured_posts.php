...
<div class="box">
    <div class="box-header">
        <div class="left">
            <h3 class="box-title">Featured Posts</h3>
            <br>
            <small class="pull-left">You can see featured posts here</small>
        </div>
        <div class="right">
                    ...
                    <table class="table table-bordered table-striped dataTable" id="cs_datatable" role="grid"
                        ...
                        <?php foreach ($posts as $item): ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo form_open('post/featured_posts_order_post'); ?>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu pull-right options-list">
                                            <li>
                                                <a href="<?php echo base_url(); ?>admin/update-post/<?php echo html_escape($item->id); ?>?redirect_url=featured-posts">
